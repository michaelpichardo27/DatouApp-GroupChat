...
class _$UserImpl implements _User {
  const _$UserImpl({
    ...
    this.lastSignInAt,
    @JsonKey(name: 'user_metadata') final Map<String, dynamic>? userMetadata,
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, phoneNumber: $phoneNumber, createdAt: $createdAt, lastSignInAt: $lastSignInAt, userMetadata: $userMetadata)';
  }
